...
export default class ShadowCityNPC extends ShadowCityActorBase {
  ...
  static defineSchema() {
    ...
    schema.habits = new fields.StringField({ required: true, nullable: false, initial: "" }); 
    schema.move = new fields.StringField({ required: true, nullable: false, initial: "near" }); 
    schema.moveExtra = new fields.StringField({ required: true, nullable: false, initial: "" }); 
