...
import { ShadowCityActor } from './documents/actor.mjs';
...
Hooks.once('init', function () {
  ...
  CONFIG.Actor.documentClass = ShadowCityActor;

  // Note that you don't need to declare a DataModel
  // for the base actor/item classes - they are included
  // with the Character/NPC as part of super.defineSchema()
  CONFIG.Actor.dataModels = {
    character: models.ShadowCityCharacter,
    npc: models.ShadowCityNPC
  }
  CONFIG.Item.documentClass = ShadowCityItem;
  CONFIG.Item.dataModels = {
    item: models.ShadowCityItem,
    asset: models.ShadowCityAsset,
    touchstone: models.ShadowCityTouchstone,
    discipline: models.ShadowCityDiscipline,
    background: models.ShadowCityBackground,
...
async function createItemMacro(data, slot) {
  ...
  const command = `game.shadowcitybloodneonvtt.rollItemMacro("${data.uuid}");`;
  ...
  if (!macro) {
    macro = await Macro.create({
      ...
      img: item.img,
      command: command,
      flags: { 'shadowcity-blood-neon-vtt.itemMacro': true },
    });
  }
